...
export declare function provide( key: string | symbol, value: any );

export declare function onMount( callback: () => void );

export declare function onDestroy( callback: () => void );
